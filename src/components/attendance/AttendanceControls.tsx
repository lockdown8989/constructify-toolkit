...
const AttendanceControls = ({
  ...
  return <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 mb-4 md:mb-6">
      <div className="flex items-center gap-2 w-full md:w-auto">
        <div className="flex items-center p-1 bg-gray-100 rounded-lg">
          ...
          <h3 className="text-sm md:text-base font-medium px-2 text-zinc-950">
        ...
        {!isMobile && <Button variant="outline" size="sm" className="ml-2 h-8" onClick={handleTodayClick}>
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center gap-2 w-full md:w-auto">
        ...
        {canSelectEmployees && <Select onValueChange={onEmployeeSelect}>
        ...
        {canSelectEmployees && <Input type="search" placeholder="Search employee" className="md:w-48 h-9" onChange={e => onSearchChange(e.target.value)} />}
        ...
        {isMobile && <Button variant="outline" size="sm" className="h-9">
            <Calendar className="h-3.5 w-3.5 mr-1.5" />
            <span>Today</span>
          </Button>}
      </div>
