...
import WeeklyGridWithHeatmap from './WeeklyGridWithHeatmap';

interface RestaurantScheduleGridWithHeatmapProps {
  employees: Employee[];
  weekStats: WeekStats;
...
const RestaurantScheduleGridWithHeatmap: React.FC<RestaurantScheduleGridWithHeatmapProps> = ({
  employees,
  weekStats,
  openShifts,
  formatCurrency,
  ...
  console.log('RestaurantScheduleGridWithHeatmap rendering with employees:', employees.length);
...
export default RestaurantScheduleGridWithHeatmap;
