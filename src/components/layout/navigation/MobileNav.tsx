...
const MobileNav = ({ isAuthenticated }: MobileNavProps) => {
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="w-[85%] max-w-[300px] pb-safe-area-inset-bottom p-0">
        <SheetHeader className="text-left px-4 py-4">
          <SheetTitle>TeamPulse</SheetTitle>
        </SheetHeader>
        <ScrollArea className="h-[calc(100vh-80px)]">
          <nav className="grid gap-4 px-4 py-4">
            <Link
              to="/"
