...
const RestaurantSchedule = () => {
  console.log('RestaurantSchedule component rendering...');
  ...
  try {
    ...
    console.log('RestaurantSchedule hooks loaded successfully', { 
    ...
    console.log('RestaurantSchedule rendering main content');
    ...
    console.error('Error in RestaurantSchedule component:', error);
    return (
      <div className="container py-6 sm:py-8 max-w-[1400px] px-3 md:px-6 mx-auto">
