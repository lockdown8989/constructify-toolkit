-- Add 'incomplete' status to schedule status type
ALTER TYPE schedule_status_type RENAME TO schedule_status_type_old;
...
-- Update existing schedules table to use new enum
ALTER TABLE schedules 
ALTER COLUMN status TYPE schedule_status_type USING status::text::schedule_status_type;

-- Drop old enum type
DROP TYPE schedule_status_type_old;
...
-- Add trigger on attendance table updates
